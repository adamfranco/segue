...
new Type('Authentication', 'edu.middlebury.harmoni', 'Middlebury LDAP');
$GLOBALS['dataport_migration_auth_types'] = array(new Type('Authentication', 'edu.middlebury.harmoni', 'LDAP')
);