 ...
 *
 * @version $Id: EditModeSiteVisitor.class.php,v 1.35 2008/04/10 04:16:58 achapin Exp $
 */
...
END;
	...
	function getTags ( $block ) {
		...
		print TagAction::getTagCloudForItem(TaggedItem::forId($block->getQualifierId(), 'segue'), 'sitetag',
				array(	'font-size: 90%;',
						'font-size: 100%;',
				));		
