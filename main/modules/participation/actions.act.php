	...
	extends MainWindowAction
{
	...
	private function getActionsList () {
		...
		$printer = new ParticipationResultPrinter($selectedActions, $headRow, array($this, 'printAction'));
	...
	public function printAction (Participation_Action $action) {
		ob_start();
		print  "\n\t\t\t<td class='participation_row'>".$action->getTimeStamp()->format("Y-m-d g:i a")."\n\t\t\t</td>";
		print "\n\t\t\t<td class='participation_row'><a href='";
