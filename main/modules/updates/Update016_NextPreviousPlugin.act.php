 ...
 * @version $Id: Update005_RssAndBreadcrumbs.act.php,v 1.1 2008/03/21 19:18:18 adamfranco Exp $
 */
class Update016_NextPreviousPluginAction
	extends Update
{
	...
	function getDateIntroduced () {
		$date = Date::withYearMonthDay(2008, 8, 27);
		return $date;
	}
	...
	function getDescription () {
		return _("This update will install and enable the new Next/Previous plugin.");
	}
	...
	function isInPlace () {
		...
		if (!$pluginMgr->isInstalled(new Type ('SeguePlugins', 'edu.middlebury', 'NextPrevious')))
			return false;
		if (!$pluginMgr->isEnabled(new Type ('SeguePlugins', 'edu.middlebury', 'NextPrevious')))
			return false;
