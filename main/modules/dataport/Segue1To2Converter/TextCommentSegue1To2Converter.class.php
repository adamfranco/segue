 ...
 *
 * @version $Id: TextCommentSegue1To2Converter.class.php,v 1.1 2008/02/14 20:25:43 adamfranco Exp $
 */ 
 ...
 * @version $Id: TextCommentSegue1To2Converter.class.php,v 1.1 2008/02/14 20:25:43 adamfranco Exp $
 */
class TextCommentSegue1To2Converter
	extends CommentSegue1To2Converter
{
	...
	public function __construct (DOMElement $sourceElement, DOMXPath $sourceXPath, DOMDocument $doc, DOMXPath $xpath, Segue1To2Director $director) {
		...
		$this->surrogate = new TextBlockSegue1To2Converter($sourceElement, $sourceXPath, $doc, $xpath, $director);
	}
