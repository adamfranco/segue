...
class TableDiffFormatter extends DiffFormatter
{
	...
	function _block_header( $xbeg, $xlen, $ybeg, $ylen ) {
		$r = '<tr><td colspan="2" style="text-align: left"><strong>Line '.$xbeg."</strong></td>\n" .
		  '<td colspan="2"  style="text-align: left"><strong>Line '.$ybeg."</strong></td></tr>\n";
		return $r;
	}
...
/**
 * This class was added to format the diffs for use in the Segue Learning Management
 * system.
 * http://segue.sf.net
 * Added by Adam Franco afranco@middlebury.edu
 * 
 * @since 2/7/07
 * @package segue
 * 
