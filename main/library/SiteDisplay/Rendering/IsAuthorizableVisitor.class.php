 ...
 *
 * @version $Id: IsAuthorizableVisitor.class.php,v 1.1 2007/11/08 20:17:10 adamfranco Exp $
 */ 

require_once(dirname(__FILE__)."/SiteVisitor.interface.php");

/**
 * Return true if passed to site component that can have authorizations applied
 * 
 * @since 5/24/07
 * @package segue.libraries.site_display
 * 
