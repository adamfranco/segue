 ...
 *
 * @version $Id: AllRowsLayoutTemplateVisitor.class.php,v 1.1 2006/02/20 21:53:09 adamfranco Exp $
 */ 
 ...
 * @version $Id: AllRowsLayoutTemplateVisitor.class.php,v 1.1 2006/02/20 21:53:09 adamfranco Exp $
 */
class AllRowsLayoutTemplateVisitor
	extends LayoutTemplateVisitor
{
	...
	function visitNavigationNode ( &$nodeRenderer ) {
		...
		$part->updateValue(String::withValue('rows'));
