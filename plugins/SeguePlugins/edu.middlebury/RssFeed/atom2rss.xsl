...
<x:stylesheet version="1.0" exclude-result-prefixes="atom xhtml php" xmlns:php="http://php.net/xsl" xmlns:x="http://www.w3.org/1999/XSL/Transform" xmlns:atom="http://www.w3.org/2005/Atom" xmlns:dc="http://purl.org/dc/elements/1.1/" xmlns:xhtml="http://www.w3.org/1999/xhtml">
<x:output encoding="utf-8" indent="yes" method="xml" media-type="application/rss+xml"/>

<x:template name="warningForClickers">
	<x:comment><div xmlns="http://www.w3.org/1999/xhtml">
		<style type="text/css">template {visibility:hidden;} p {visibility:visible;}</style>
		<p>This file is not supposed to be viewed in a web browser. You should use it with server-side XSLT processor.</p>
	</div></x:comment>
</x:template>
